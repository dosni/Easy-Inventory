...
#nullable disable
        ...
        static IDictionary<Guid, SignInRequest<TUser>> Logins { get; set; }
            = new ConcurrentDictionary<Guid, SignInRequest<TUser>>();

        public static Guid AnnounceLogin(SignInRequest<TUser> loginInfo)
        {
        ...
        public static SignInRequest<TUser> GetLoginInProgress(string key)
        {
            return GetLoginInProgress(Guid.Parse(key));
        }

        public static SignInRequest<TUser> GetLoginInProgress(Guid key)
        {
